    ...
    <div className='px-6 sm:px-6 lg:px-20 bg-white max-w-[1440px] min-w-[80%] mx-auto h-[64px] flex justify-between items-center'>
      <div className='flex'>
        <img
          ...
          className='cursor-pointer mr-6 xl:mr-8'
        />
        <section className='hidden lg:flex gap-6 xl:gap-8 text-sm'>
          <div className='w-full flex items-center gap-1 cursor-pointer'>
            <div
              style={{ backgroundImage: `url(${DashboardImgBG})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}
              className='flex items-center justify-center w-[62px] h-[62px] '
            >
        ...
        <div className='rounded-full w-28 h-10 bg-gradient-to-b p-[4px] from-[#CC00FF] to-[#3300FF] cursor-pointer'>
          <div className='flex flex items-center justify-between h-full bg-[#130B43] text-white rounded-full p-4 relative'>
            ...
            <span className='absolute rounded-full bg-white top-[-14px] right-[-12px] py-[1px] px-[3px] p-[8px]'>
              <span className='py-[0.1px] px-[6px] bg-[#D85050] rounded-[50%] text-center text-white text-sm font-thin '>&nbsp;&nbsp;</span>
            </span>
          </div>
        </div>

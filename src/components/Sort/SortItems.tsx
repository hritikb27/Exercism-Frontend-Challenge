      ...
      {({ open }) => (
        <>
          <div className="mt-1 relative w-full max-h-[70%] h-[50px] mb-2 ">
            <Listbox.Button className="relative w-full h-full bg-[#F0F3F9] rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-[#2E57E8] focus:border-[#2E57E8] sm:text-sm">
